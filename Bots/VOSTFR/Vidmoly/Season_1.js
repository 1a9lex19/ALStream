...
const DB_NAME = 'C:\\Users\\Alex19\\Desktop\\Program\\Clear\\Data\\Anime Links\\VOSTFR\\Season 1\\Vidmoly\\Season_1.db';
const JSON_FILE = 'C:\\Users\\Alex19\\Desktop\\Program\\Clear\\Data\\Anime Links\\VOSTFR\\Season 1\\Vidmoly\\Season_1.json';
...
io.on('connection', (socket) => {
    ...
    socket.on('start', async (data) => {
        ...
        log(`🚀 Démarrage du Bot (Mode : Saisons 1+ Uniquement)`, 'info');
...
async function runBot(startFromName = null) {
    ...
    for (const link of allAnimeLinks) {
        ...
        // =====================================================================
        // VÉRIFICATION D'EXISTENCE DE LA SAISON 1 + vidmoly
        // =====================================================================
        let hasValidSeason1 = false;
        log(`🔍 Vérification présence Saison 1 + vidmoly...`, 'info');
