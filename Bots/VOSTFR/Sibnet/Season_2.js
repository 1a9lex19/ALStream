...
const DB_NAME = 'C:\\Users\\Alex19\\Desktop\\Program\\Clear\\Data\\Anime Links\\VOSTFR\\Season 2\\Sibnet\\Season_2.db';
const JSON_FILE = 'C:\\Users\\Alex19\\Desktop\\Program\\Clear\\Data\\Anime Links\\VOSTFR\\Season 2\\Sibnet\\Season_2.json';
...
io.on('connection', (socket) => {
    ...
    socket.on('start', async (data) => {
        ...
        log(`🚀 Démarrage du Bot (Mode : Saisons 2)`, 'info');
...
async function runBot(startFromName = null) {
    ...
    // -------------------------------------------------------------------------
    // PHASE 2 : TRAITEMENT (FILTRE SAISON 2)
    // -------------------------------------------------------------------------
    ...
    for (const link of allAnimeLinks) {
        ...
        // =====================================================================
        // VÉRIFICATION D'EXISTENCE DE LA SAISON 2 + sibnet
        // =====================================================================
        let hasValidSeason2 = false;
        log(`🔍 Vérification présence Saison 2 + sibnet...`, 'info');
        ...
        if (!hasValidSeason1) {
            log(`⏩ Anime ignoré (Pas de Saison 2 ou pas de sibnet).`, 'skip');
            continue;
        }

        log(`✅ Saison 2 validée. Démarrage...`, 'success');

        // =====================================================================
        // BOUCLE DE SCRAPING (Commence à s=2)
        // =====================================================================
        let stopAnime = false;
...
server.listen(2500, () => { // <--- Changement ici
    console.log('✅ Serveur lancé sur http://localhost:2500');
});