...
const DB_NAME = 'C:\\Users\\Alex19\\Desktop\\Program\\Clear\\Data\\Anime Links\\VOSTFR\\Season 3\\Sibnet\\Season_3.db';
const JSON_FILE = 'C:\\Users\\Alex19\\Desktop\\Program\\Clear\\Data\\Anime Links\\VOSTFR\\Season 3\\Sibnet\\Season_3.json';
...
io.on('connection', (socket) => {
    ...
    socket.on('start', async (data) => {
        ...
        log(`🚀 Démarrage du Bot (Mode : Saisons 3)`, 'info');
...
async function runBot(startFromName = null) {
    ...
    for (const link of allAnimeLinks) {
        ...
        // =====================================================================
        // VÉRIFICATION D'EXISTENCE DE LA SAISON 3 + sibnet
        // =====================================================================
        let hasValidSeason3 = false;
        log(`🔍 Vérification présence Saison 3 + sibnet...`, 'info');
        ...
        if (!hasValidSeason1) {
            log(`⏩ Anime ignoré (Pas de Saison 3 ou pas de sibnet).`, 'skip');
            continue;
        }
...
server.listen(3500, () => { // <--- Changement ici
    console.log('✅ Serveur lancé sur http://localhost:3500');
});