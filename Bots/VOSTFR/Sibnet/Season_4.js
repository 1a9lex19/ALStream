...
const DB_NAME = 'C:\\Users\\Alex19\\Desktop\\Program\\Clear\\Data\\Anime Links\\VOSTFR\\Season 4\\Sibnet\\Season_4.db';
const JSON_FILE = 'C:\\Users\\Alex19\\Desktop\\Program\\Clear\\Data\\Anime Links\\VOSTFR\\Season 4\\Sibnet\\Season_4.json';
...
io.on('connection', (socket) => {
    ...
    socket.on('start', async (data) => {
        ...
        log(`🚀 Démarrage du Bot (Mode : Saisons 4)`, 'info');
...
async function runBot(startFromName = null) {
    ...
    for (const link of allAnimeLinks) {
        ...
        // =====================================================================
        // VÉRIFICATION D'EXISTENCE DE LA SAISON 4 + sibnet
        // =====================================================================
        let hasValidSeason4 = false;
        log(`🔍 Vérification présence Saison 4 + sibnet...`, 'info');
        ...
        if (!hasValidSeason1) {
            log(`⏩ Anime ignoré (Pas de Saison 4 ou pas de sibnet).`, 'skip');
            continue;
        }
...
server.listen(4500, () => { // <--- Changement ici
